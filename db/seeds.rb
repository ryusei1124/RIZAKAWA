...
User.create!(guardian:"多田千晴",guardiankana:"タダチハル",email:"sample-14@email.com",password:"password",password_confirmation:"password")
User.create!(guardian:"上田沙知",guardiankana:"ウエダユウ",email:"sample-15@email.com",password:"password",password_confirmation:"password")
...
Student.create!(student_name:"工藤沙知",studentkana:"クドウナナ",zoom:false,birthday:"2012/1/10",fix_day:"土",fix_time:"10:10",user_id:8)
Student.create!(student_name:"工藤勉",studentkana:"クドウベン",zoom:false,birthday:"2010/12/24",fix_day:"日",fix_time:"10:30",user_id:8)
Student.create!(student_name:"工藤奈々",studentkana:"クドウナナ",zoom:false,birthday:"2008/08/24",fix_day:"土",fix_time:"10:30",user_id:8)
