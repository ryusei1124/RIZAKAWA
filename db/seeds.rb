...
User.create!(guardian:"柳生進",guardiankana:"ヤギュウススム",email:"sample-16@email.com",password:"password",password_confirmation:"password")
Student.create!(student_name:"山田良子",studentkana:"ヤマダヨシコ",zoom:false,birthday:"2004/4/10",fix_day:"月",fix_time:"19:10",user_id:2)
Student.create!(student_name:"山田太郎",studentkana:"ヤマダタロウ",zoom:false,birthday:"2010/4/10",fix_day:"火",fix_time:"16:10",user_id:2)
