class ManegerStudentsController < ApplicationController
  ...
  private
  def student_params
     params.require(:student).permit( :id, :school, :zoom, :examinee, :fix_day, :fix_time, :fix_day2, :fix_time2, :fix_day3, :fix_time3, :fix_day4, :fix_time4, :fix_day5, :fix_time5, :note)
  end
  def lesson_params
